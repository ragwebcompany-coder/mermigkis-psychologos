  ...
  return (
    <>
      <PageHero
        eyebrow="Ο χώρος"
        title="Το γραφείο"
        intro="Ένας ήσυχος χώρος στα Μελίσσια, με ραντεβού που ορίζονται ώστε να μη συμπίπτουν — η ώρα σας είναι δική σας."
      />
        ...
        <Reveal>
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-8 max-w-2xl text-[1.0625rem] leading-[1.9] text-ink-700 text-pretty">
              Οι συνεδρίες γίνονται στο ιδιωτικό γραφείο στην Παναγή Τσαλδάρη 21
              στα Μελίσσια. Όπου από το ιστορικό προκύψει ανάγκη εργαστηριακού ελέγχου
      ...
      <Section className="bg-cream-100 pb-0 sm:pb-0">
        <Reveal>
          <SectionHead
            eyebrow="Ο χώρος"
            title="Τέσσερις λήψεις από το γραφείο"
            intro="Από τη θέση όπου γίνεται η συνεδρία μέχρι την πινακίδα στην είσοδο."
          />
        </Reveal>
        <Reveal delay={120}>
          <div className="mt-14">
